...
With a clearly defined set of goals, features and a roadmap for my library, I'm not ready to get started. In the next section, we'll set up the project for +slacker.js+.
